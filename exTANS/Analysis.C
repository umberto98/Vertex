...
void Analysis(){
	...
	for (int imult=0; imult<nmultbins; imult++){
		hresmult[imult]=new TH1F(Form("hzremult_multbin%d",imult),Form(" Residuals for event with multiplicity between %d and %d",multlims[imult],multlims[imult+1]-1),100,-1000,1000);
